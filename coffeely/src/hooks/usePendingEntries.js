  ...
  return useMemo(() => {
    ...
    if (frecuencia === 'diario') {
      ...
      if (business.registrosDiarios?.length > 0) {
        // Solo contar días de mora si ya existe al menos un registro previo
        ...
        // Sin ningún registro previo: no hay días de mora ni alarma.
        // pendienteHoy también se desactiva — es el primer uso, no una omisión.
        pendienteHoy = false
        diasSinRegistrar = 0
      }
    } else {
